    ...
    <div class="contenedor-2">
      <div class="text-column2">
        ...
        <div class="felcha-1">
          ...
          <a href="../HTML/artesVisuales.php"><img class="felcha" src="../MEDIA/IMG/flecha2.png" alt=""></a>
        </div>
    ...
    <div class="column-left">
      ...
      <div class="text-tip">
        ...
        <p> Por eso, lo mejor es empezar con lo más básico:
          ...
          <br>En la cual comienzas con formas básicas en las que cuadren las proporciones y definas el espacio de tu papel o dibujo.Ya luego podras continuar con sombras y detalles. Te ahorra tiempo, frustraciones, estrés... ¡y papel!
        </p>
      </div>
    </div>
  </section>
