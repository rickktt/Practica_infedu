        ...
        <ul class="menu">
            ...
            <li><a href="../HTMLEN/artesVisuales.php">Visual Arts<img class="im" src="../MEDIA/IMG/flechas.png"></a>
                <ul>
                    ...
                    <li class="divider"></li> 
                    <li><a href="../HTMLEN/artesPlasticas.php">Plastic Arts</a></li>
                    <li class="divider"></li> 
                    <li><a href="../HTMLEN/artesGraficas.php">Graphic Arts</a></li>
                    <li class="divider"></li> 
                    <li><a href="../HTMLEN/artesPopulares.php">Popular Art</a></li>
                    <li class="divider"></li> 
                </ul>
            </li>
            <li><a href="../HTMLEN/galeria.php">Gallery<img src="../MEDIA/IMG/flechas.png"></a>
                <ul>
