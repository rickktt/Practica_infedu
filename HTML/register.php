...
<body class="fondo">
    ...
    <nav class="nav">
      <ul class="menu">
        ...
        <li><a href="../HTML/register.php">Artes Visuales<img src="../MEDIA/IMG/flechas.png"></a>
          <ul>
            <li><a href="../HTML/register.php">Arte</a></li>
            <li class="divisor"></li>
            <li><a href="../HTML/register.php">Arte Contemporáneo</a></li>
            <li class="divisor"></li>
        ...
        <li><a href="../HTML/register.php">Galería</a></li>
  ...
  <div class="glass">
    <form class="register-box" action="../PHP/registro_conexion.php" method="post">
      ...
      <input name="correo" type="email" placeholder="Digite el correo electrónico" required>
