...
<body class="background">
  ...
  <section class="section2">
    ...
    <main>
      ...
      <div class="caja-lateral">
        ...
        <blockquote><strong> Es alrededor de 1980 cuando el término “Artes Visuales” empieza a predominar en el
            vocabulario pues es más adecuado para el arte contemporáneo que la denominación Artes
            Plásticas.</strong></blockquote>
      </div>
    </main>
  ...
  <section class="estetica-section">
    <div class="columna-izquierda">
      <h2>Criterios Estéticos</h2>
      <ul>
        <li>La armonía.</li>
        <li>El color.</li>
        <li>La composición.</li>
        <li>El espacio.</li>
        <li>El equilibrio.</li>
        <li>La luz.</li>
        <li>El movimiento.</li>
    ...
    <div class="columna-derecha">
      <h2>Ideas básicas que definen el Arte visual</h2>
  ...
  <section class="seccion-arte">
    <div class="texto-izquierda">
      <h2>Las artes visuales son importante porque:</h2>
      <ul>
  ...
  <section class="titulo">
    ...
    <div class="tarjetas">
      <div class="tarjeta">
        ...
        <p>Todas aquellas artes que utilizan materiales moldeables o manipulables en su proceso de creación.</p>
        <p><em>Pintura, Dibujo, Escultura, Grabado, Cerámica...</em></p>
      ...
      <div class="tarjeta">
        ...
        <p>Conjunto de técnicas que generan elementos visuales a partir de grabados, dibujos y métodos informáticos.</p>
        <p><em>Ilustración, Tipografía y Lettering...</em></p>
      ...
      <div class="tarjeta">
        ...
        <p>Manifestaciones artísticas que surgen a partir del siglo XX.</p>
        <p><em>Arte Digital, Arte Conceptual, Arte Urbano...</em></p>
